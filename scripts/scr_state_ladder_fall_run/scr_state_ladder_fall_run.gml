/// @description scr_state_ladder_fall_run(o_actor)
/// @param actor_id
function scr_state_ladder_fall_run() {
	...
	var vel_y = ID.v_act_vel_y + state.v_state_ladder_fallacc;
	clamp(vel_y, 0, state.v_state_ladder_fallspd_max);
