...
if (global.optionsactive) {
	v_optionsmenu_rectwidth = v_optionsmenu_rectwidth_max * global.menu_scale_x;
	v_optionsmenu_rectheight = v_optionsmenu_rectheight_max * global.menu_scale_y;
	v_optionsmenu_rectx = global.gui_width/2 - v_optionsmenu_rectwidth/2;
	v_optionsmenu_recty = global.gui_height/2.4 - v_optionsmenu_rectheight/2;
	
	//menu panel
	var x2 = v_optionsmenu_rectx + v_optionsmenu_rectwidth;
	var y2 = v_optionsmenu_recty + v_optionsmenu_rectheight;
	var borderx = v_optionsmenu_border * global.menu_scale_x;
	var bordery = v_optionsmenu_border * global.menu_scale_y;
	...
	for (i = 0; i < v_optionsmenu_items; i++) {//remember that this is drawing bottom up
		...
		var xx = global.gui_width/v_optionsmenu_x;
		var yy = global.gui_height/v_optionsmenu_y - v_optionsmenu_itemheight * i * v_optionsmenu_spacer * global.menu_scale_y;
		draw_set_color(color);
		draw_set_alpha(1);
		draw_text_transformed(global.gui_width/v_optionsmenu_pointerxxdivide, yy, cursor, global.menu_scale_x, global.menu_scale_y, 0);
